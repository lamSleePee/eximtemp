        ...
        <>
            <div className="gmap-main">
                <div className="gmap-text">
                    ...
                    <p className="address"><i class="fa-solid fa-house"></i>  <a className='gmap-icon' href="https://www.google.com/maps/search/37-Satakunnankatu,Tampere,Finland-33210">37- Satakunnankatu, Tampere, Finland-33210</a></p>
